<template>
	<view class="container">
		<!-- 登录容器 -->
		<view class="title-box"><text>忘记密码</text></view>
		<!-- 输入容器 -->
		<view class="input-box">
			...
			<view class="input-row">
				<text>密码</text>
				<input type="text" v-model="passData1" maxlength="36" placeholder="请输入新密码" :password="!showPassword1" />
				<image class="icon-image" :src="showPassword1 ? '/static/login/op.png' : '/static/login/cl.png'" @tap="display1"></image>
			</view>
			<view class="input-row">
				<text>确认密码</text>
				<input type="text" v-model="passData2" maxlength="36" placeholder="请再次确认新密码" :password="!showPassword2" />
		...
		<view class="button-box">
			<button type="primary" class="button-body" @tap="submit()">修改密码</button>
		</view>
	</view>
</template>
